...
<?php $component->withAttributes([]); ?>
  ...
  <form action="<?php echo e(route('administrator.account.admin.update', $user->id)); ?>" method="post">
    <?php echo csrf_field(); ?> 
    <?php echo method_field('PUT'); ?>
    
    <?php echo $__env->make('vendor.ladmin.user._partials._form', ['user' => $user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\manajemenspbe\resources\views/vendor/ladmin/user/edit.blade.php ENDPATH**/ ?>