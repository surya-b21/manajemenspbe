...
<?php $component->withAttributes([]); ?>
  ...
  <form action="<?php echo e(route('administrator.access.role.store')); ?>" method="post">
    <?php echo csrf_field(); ?> 
    
    <?php echo $__env->make('vendor.ladmin.role._partials._form', ['role' => (new App\Models\Role)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\manajemenspbe\resources\views/vendor/ladmin/role/create.blade.php ENDPATH**/ ?>