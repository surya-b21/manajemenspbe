                                                                  ...
                                                                  <div class="left-text mb-4">
                                                                      ...
                                                                      <form action="/inovasi/kategori" method="post" enctype="multipart/form-data"> 
                                                                          ...
                                                                          <div class="input-group mb-3">
                                                                              ...
                                                                              <input type="hidden" name="id_kategori" value="{{$id_jenis}}">
                                                                              <button class="btn btn-primary w-100 rounded" type="submit" name="submit">
                                                                                  Jelajahi → <img style="width:15px; height:15px" src="{{asset('template2/assets/images/service-icon-01.png')}}" alt=""> {{$ks['element']}}
                                                                              </button>
                                                                          </div>
                                                                      </form>
                                                              </div>
                                                          ...
                                                          <div class="col-lg-6 align-self-center">
                                                              ...
                                                              <form action="/inovasi/kategori" method="post" enctype="multipart/form-data"> 
                                                                  ...
                                                                  <div class="input-group mb-3">
                                                                      ...
                                                                      <input type="hidden" name="id_kategori" value="{{$id_jenis}}">
                                                                      <button class="btn btn-primary w-100 rounded" type="submit" name="submit">
                                                                          Jelajahi → <img style="width:15px; height:15px" src="{{asset('template2/assets/images/service-icon-01.png')}}" alt=""> Layanan Administrasi Pemerintah
                                                                      </button>
                                                                  </div>
                                                              </form>
                                                          </div>
                                                          ...
                                                          <div class="col-lg-6 align-self-center">
                                                              ...
                                                              <form action="/inovasi/kategori" method="post" enctype="multipart/form-data"> 
                                                                  ...
                                                                  <div class="input-group mb-3">
                                                                      ...
                                                                      <input type="hidden" name="id_kategori" value="{{$id_jenis}}">
                                                                      <button class="btn btn-primary w-100 rounded" type="submit" name="submit">
                                                                          Jelajahi → <img style="width:15px; height:15px" src="{{asset('template2/assets/images/service-icon-01.png')}}" alt=""> Layanan Publik
                                                                      </button>
                                                                  </div>
                                                              </form>
                                                          </div>
